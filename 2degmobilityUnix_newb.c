...
/*******************************************BEGIN INPUT FILE READ SECTION *********************************/
 ...
 double one_by_tau_for_a_slab_of_dopant(int heterointerface_or_quantum_well,
										...
										double N2d, double N_depletion_charge_density,
										double m_eff,
										double epsilonr,
										int option1,
										int option2,
  ...
  fang_howard_b_in_nanometer = 1.0e-9*pow(12*m_eff*electron_charge*electron_charge*(N_depletion_charge_density+0.34375*N2d)/(hbar*hbar*epsilon0*epsilonr),1.0/3.0);
